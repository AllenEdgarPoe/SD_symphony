...
parser.add_argument("--xformers", default=True, action='store_true', help="enable xformers for cross attention layers")
...
parser.add_argument("--api", default=True,action='store_true', help="use api=True to launch the API together with the webui (use --nowebui instead for only the API)")
